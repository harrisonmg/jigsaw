...
fn event_io(
    ...
    fn forward_events<T: Send + Sync + GameEvent + 'static>(
    ...
    forward_events(
        &mut piece_moved_reader,
        &mut piece_moved_events,
        &network_io,
    );
    forward_events(
        &mut piece_picked_up_reader,
        &mut piece_picked_up_events,
        &network_io,
    );
    forward_events(
        &mut piece_put_down_reader,
        &mut piece_put_down_events,
        &network_io,
    );
    forward_events(
        &mut piece_connection_reader,
        &mut piece_connection_events,
        &network_io,
    );
    forward_events(
        &mut player_cursor_moved_reader,
        &mut player_cursor_moved_events,
        &network_io,
    );
    forward_events(
        &mut player_disconnected_reader,
        &mut player_disconnected_events,
        &network_io,
    );
